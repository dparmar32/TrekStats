...
Create a travel application that allows a user to retrive information for travel, weather and map based on city using one application.


## User Story 📖

```md
Create a travel application that allows a user to retrive information for travel, weather and map based on city name.
